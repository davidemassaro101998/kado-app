...
export const TRANSLATIONS: Record<Language, Translations> = {
  en: {
    ...
    curating: "CURATING...",
    curatingSub: "Matching your answers to real gift ideas...",
    ...
    legalPrivacyItem4Title: "4. Third-Party Services (Google Gemini AI & Amazon):",
  ...
  it: {
    ...
    curatingSub: "Ricerca di idee regalo in base alle preferenze indicate...",
    ...
    legalPrivacyItem4Title: "4. Servizi Terzi (Google Gemini AI & Amazon):",
    ...
    cookieText: "Kado AI utilizza cookie tecnici e servizi di affiliazione per consigliarti idee regalo. Continuando ad usare l'app accetti la nostra Privacy Policy.",
  ...
  es: {
    ...
    curatingSub: "Buscando ideas de regalo según tus preferencias...",
    ...
    legalPrivacyItem4Title: "4. Servicios de Terceros (Google Gemini AI y Amazon):",
    ...
    cookieText: "Kado AI utiliza cookies técnicas y servicios de afiliación para recomendarte ideas de regalo. Al continuar usando la app, aceptas nuestra Política de Privacidad.",
  ...
  fr: {
    ...
    curatingSub: "Recherche d'idées cadeaux selon vos préférences...",
    ...
    legalPrivacyItem4Title: "4. Services Tiers (Google Gemini AI et Amazon) :",
    ...
    cookieText: "Kado AI utilise des cookies techniques et des services d'affiliation pour vous recommander des idées cadeaux. En continuant à utiliser l'application, vous acceptez notre Politique de Confidentialité.",
  ...
  de: {
    ...
    curatingSub: "Suche nach Geschenkideen passend zu deinen Vorlieben...",
    ...
    legalPrivacyItem4Title: "4. Drittanbieterdienste (Google Gemini AI & Amazon):",
    ...
    cookieText: "Kado AI verwendet technische Cookies und Partnerdienste, um dir Geschenkideen zu empfehlen. Durch die weitere Nutzung der App akzeptierst du unsere Datenschutzerklärung.",
