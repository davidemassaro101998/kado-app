      ...
      <div className="shrink-0 pt-0.5">
        ...
        >
          <div className="flex items-center gap-2.5 flex-1 min-w-0">
            <Search className="w-4 h-4 text-[#68686D] group-hover:text-[#FF4D6D] transition-colors shrink-0" />
              ...
              <div className="grid grid-cols-2 gap-2.5 sm:gap-3 pt-1">
                {recipientOptions.map((opt) => {
                  ...
                  return (
                    ...
                    >
                      <div className={`w-10 h-10 sm:w-11 sm:h-11 rounded-2xl flex items-center justify-center transition-colors ${isSel ? "bg-white/20 text-white" : "bg-[#F2F2F7] text-[#FF4D6D]"}`}>
                ...
                <div className="relative flex items-center">
                  <span
                    className={`absolute left-3.5 text-sm font-bold transition-colors ${
                      isCustomBudgetFocused || customBudgetInput ? "text-[#FF4D6D]" : "text-[#68686D]"
                    }`}
                  >
                    €
                  </span>
              ...
              <div className="p-3.5 rounded-[22px] bg-white border border-[#E5E5EA] shadow-[0_8px_24px_rgba(0,0,0,0.04)] space-y-2 compact-card">
                ...
                <label className="flex items-center gap-2.5 cursor-pointer select-none">
                  <input
                    ...
                    className="w-4 h-4 rounded border-[#E5E5EA] text-[#FF4D6D] focus:ring-0 accent-[#FF4D6D] cursor-pointer"
                  />
                ...
                <input
                  ...
                  className="w-full py-2 px-3 rounded-xl bg-[#F2F2F7] border border-[#E5E5EA] text-[#000000] placeholder-[#68686D] text-xs sm:text-sm font-normal focus:outline-none focus:border-[#FF4D6D]"
                />
              </div>
            </motion.div>
          )}
