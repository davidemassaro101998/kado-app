          ...
          >
            ...
            <div className="flex items-center justify-between pb-3 border-b border-[#2B2130] mb-3">
              <div className="flex items-center gap-2">
                <div className="p-2 rounded-xl bg-[#F14B81] text-[#0E0910] shadow-xs">
            ...
            <div className="flex-1 overflow-y-auto space-y-4 pr-1">
              ...
              <div className="space-y-2">
                ...
                >
                  <span className="flex items-center gap-2.5">
                    <Vibrate className="w-4 h-4 text-[#F14B81]" />
                  ...
                  <span
                    ...
                    className={`w-11 h-6 shrink-0 rounded-full transition-colors relative p-0.5 block ${
                      hapticEnabled ? "bg-[#F14B81]" : "bg-[#2B2130]"
                    }`}
                  >
                    <span
                ...
                <div className="p-3.5 rounded-[22px] bg-[#1C1520] border border-[#2B2130] space-y-2.5">
                  <div className="flex items-center justify-between">
                    <div className="flex items-center gap-2.5">
                      <Mic className="w-4 h-4 text-[#F14B81]" />
                      <div>
                  ...
                  {micPermission !== "granted" && (
                    <button
                      ...
                      className="w-full min-h-[44px] py-2 px-3 rounded-xl bg-[#17111A] border border-[#2B2130] hover:border-[#F14B81] text-xs font-bold text-[#F14B81] flex items-center justify-center gap-2 transition-all cursor-pointer shadow-2xs active:scale-[0.98]"
                    >
                      <Mic className="w-3.5 h-3.5 text-[#F14B81]" />
              ...
              <div className="space-y-2">
                ...
                <div className="p-1 rounded-[22px] bg-[#1C1520] border border-[#2B2130] space-y-1">
                  ...
                  >
                    <div className="flex items-center gap-2.5">
                      <ShieldCheck className="w-4 h-4 text-[#F14B81]" />
                  ...
                  >
                    <div className="flex items-center gap-2.5">
                      <FileText className="w-4 h-4 text-[#F14B81]" />
                  ...
                  >
                    <div className="flex items-center gap-2.5">
                      <ShoppingBag className="w-4 h-4 text-[#F14B81]" />
              ...
              <div className="space-y-2">
                ...
                <div className="p-3.5 rounded-[22px] bg-[#1C1520] border border-[#2B2130] space-y-3">
                  <button
                    ...
                    className="w-full min-h-[44px] py-2.5 px-3 rounded-xl bg-[#17111A] border border-[#2B2130] hover:border-[#F14B81] text-xs font-bold text-[#F14B81] flex items-center justify-center gap-2 transition-all cursor-pointer shadow-2xs active:scale-[0.98]"
                  >
                    <Mail className="w-4 h-4 text-[#F14B81]" />
