      ...
      <div className="flex items-center justify-between shrink-0 pt-0.5 pb-2 border-b border-[#E5E5EA]">
        <div className="flex items-center gap-2 min-w-0">
          ...
          <div className="min-w-0">
            <span className="text-[12px] font-extrabold text-[#FF4D6D] uppercase tracking-wider flex items-center gap-1">
        ...
        <button
          onClick={onStartOver}
          className="py-1 px-2.5 sm:py-1.5 sm:px-3 rounded-full bg-white border border-[#E5E5EA] text-[#FF4D6D] hover:bg-[#E5E5EA] active:scale-95 transition-transform text-[14px] font-bold shadow-2xs cursor-pointer shrink-0 ml-1 gpu-layer"
        >
          {t.newSearchBtn}
        </button>
      </div>
            ...
            <AnimatePresence mode="wait" initial={false}>
              ...
              >
                ...
                <div className="flex items-center justify-between shrink-0">
                  ...
                  {currentGift.isPrime && (
                    <span className="text-[13px] font-semibold text-[#FF4D6D] bg-[#FF4D6D]/10 px-2 py-0.5 rounded-full tracking-tight">
                      ✓ Prime
                    </span>
                  )}
                </div>
                ...
                <div className="grid grid-cols-2 gap-2 w-full shrink-0 pt-0.5">
                  <a
                    ...
                    className="min-w-0 py-2.5 sm:py-3 px-2 rounded-[16px] bg-white border-2 border-[#FF4D6D] hover:bg-[#F2F2F7] active:scale-[0.98] text-[#FF4D6D] font-black text-[13px] flex items-center justify-center gap-1.5 cursor-pointer shadow-2xs transition-all uppercase tracking-wider gpu-layer"
                  >
      ...
      <div className="shrink-0 pt-1.5 border-t border-[#E5E5EA] space-y-1">
        <div className="grid grid-cols-2 gap-2">
          ...
          <button
            ...
            className="py-2 sm:py-2.5 px-2 rounded-2xl bg-white border border-[#E5E5EA] hover:border-[#FF4D6D] text-[#000000] font-bold text-[14px] flex items-center justify-center gap-1.5 transition-colors cursor-pointer shadow-2xs active:scale-[0.98] gpu-layer"
