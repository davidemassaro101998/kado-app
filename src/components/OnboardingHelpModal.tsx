      ...
      {isOpen && (
        ...
        >
          ...
          >
            ...
            <div className="w-16 h-16 rounded-full bg-[#F14B81]/10 flex items-center justify-center shrink-0">
              <Mic className="w-7 h-7 text-[#F14B81] stroke-[2.2]" />
            </div>
            ...
            {showInstallTip && (
              <div className="w-full rounded-[18px] bg-[#1C1520] p-3.5 flex items-start gap-3">
                <div className="w-8 h-8 rounded-xl bg-[#17111A] shadow-sm flex items-center justify-center shrink-0 mt-0.5">
                  {platform === "ios" ? (
                    <Share className="w-4 h-4 text-[#F14B81]" />
                  ) : (
                    <MoreVertical className="w-4 h-4 text-[#F14B81]" />
                  )}
                </div>
            ...
            <button
              type="button"
              onClick={onDismiss}
              className="w-full py-3.5 px-6 rounded-[20px] bg-[#F14B81] hover:bg-[#D33C6B] text-[#0E0910] font-black text-sm uppercase tracking-wider active:scale-[0.98] transition-all cursor-pointer mt-1"
            >
