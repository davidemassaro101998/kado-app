    ...
    <AnimatePresence>
      ...
      >
        ...
        >
          ...
          <div className="w-16 h-16 rounded-full bg-[#1C1520] border border-[#2B2130] flex items-center justify-center text-[#9B8A93]">
            <WifiOff className="w-8 h-8 text-[#9B8A93] stroke-[2]" />
          </div>

          <div className="space-y-1.5 text-center">
            <h2 className="text-lg font-extrabold tracking-tight text-[#F7F0F2]">
              {language === "it" ? "Nessuna Connessione" : "No Connection"}
            </h2>
            <p className="text-xs text-[#9B8A93] leading-relaxed font-normal">
              {language === "it"
          ...
          <button
            onClick={handleRetry}
            disabled={isChecking}
            className="w-full mt-2 py-3.5 px-4 rounded-[18px] bg-[#FF2E7E] text-[#0E0910] font-bold text-xs uppercase tracking-wider flex items-center justify-center gap-2 cursor-pointer shadow-md active:scale-[0.97] transition-all border border-[#FF2E7E] disabled:opacity-60"
          >
