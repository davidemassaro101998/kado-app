            ...
            <div className="w-full space-y-2">
              ...
              <div className="relative w-full">
                <textarea
                  ...
                  className="w-full p-3.5 rounded-[18px] bg-[#F2F2F7] text-[#000000] placeholder-[#68686D] text-base sm:text-lg font-bold leading-snug border border-[#E5E5EA] focus:outline-none focus:border-[#FF4D6D] transition-colors resize-none"
                />
                {transcript && (
                  <button
                    type="button"
